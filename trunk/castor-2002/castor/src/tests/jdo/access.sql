...
create table test_master ( id int not null, "value" varchar(200) not null, group_id int not null );
create unique index test_master_pk on test_master ( id );
drop table test_detail;
create table test_detail ( detail_id int not null,  master_id int not null, "value" varchar(200) not null );
create unique index test_detail_pk  on test_detail ( detail_id );
drop table test_detail2;
create table test_detail2 ( detail2_id  numeric(10,0) not null, detail_id numeric(10,0) not null, value varchar(200 ) not null);
...
create table test_smaster ( id numeric(10,0) not null );
create unique index test_smaster_pk on test_smaster ( id );
drop table test_sdetail;
create table test_sdetail ( detail_id numeric(10,0) not null, master_id numeric(10,0) not null );
