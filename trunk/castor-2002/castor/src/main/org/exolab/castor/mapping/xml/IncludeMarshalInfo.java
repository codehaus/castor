...
**/
public class IncludeMarshalInfo implements org.exolab.castor.xml.MarshalInfo {
    ...
    **/
    ...
    public IncludeMarshalInfo() {
        ...
        try {
            desc.setReadMethod(Include.class.getMethod("getHref", emptyClassArgs));
            classArgs[0] = java.lang.String.class;
            desc.setWriteMethod(Include.class.getMethod("setHref", classArgs));
        }
