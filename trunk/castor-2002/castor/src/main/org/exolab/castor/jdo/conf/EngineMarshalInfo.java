...
**/
public class EngineMarshalInfo implements org.exolab.castor.xml.MarshalInfo {
    ...
    **/
    ...
    public EngineMarshalInfo() {
        ...
        try {
            desc.setReadMethod(Engine.class.getMethod("getName", emptyClassArgs));
            classArgs[0] = String.class;
            desc.setWriteMethod(Engine.class.getMethod("setName", classArgs));
        }
