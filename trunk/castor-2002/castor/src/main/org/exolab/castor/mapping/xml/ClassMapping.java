...
public class ClassMapping implements java.io.Serializable {
    ...
    **/
    ...
    } //-- void addNMTOKEN(java.lang.String)
    ...
    **/
    ...
    } //-- java.util.Enumeration enumerateNMTOKEN()
    ...
    **/
    ...
    } //-- java.lang.String getNMTOKEN(int)
    ...
    **/
    ...
    /**
    **/
    public void removeAllNMTOKEN()
    {
        _identity.removeAllElements();
    } //-- void removeAllNMTOKEN()
    ...
    **/
     ...
     * @param index
    **/
    public java.lang.String removeNMTOKEN(int index)
    {
        Object obj = _identity.elementAt(index);
        _identity.removeElementAt(index);
        return (String)obj;
    } //-- java.lang.String removeNMTOKEN(int)
    ...
    **/
    ...
    } //-- void setNMTOKEN(java.lang.String, int)

    /**
     *
     * @param nMTOKENArray
    **/
    public void setIdentity(java.lang.String[] nIdentityArray)
    {
        //-- copy array
        _identity.removeAllElements();
        for (int i = 0; i < nIdentityArray.length; i++) {
            _identity.addElement(nIdentityArray[i]);
        }
    } //-- void setNMTOKEN(java.lang.String)
