...
**/
public class JndiMarshalInfo implements org.exolab.castor.xml.MarshalInfo {
    ...
    **/
    ...
    public JndiMarshalInfo() {
        ...
        try {
            desc.setReadMethod(Jndi.class.getMethod("getName", emptyClassArgs));
            classArgs[0] = String.class;
            desc.setWriteMethod(Jndi.class.getMethod("setName", classArgs));
        }
