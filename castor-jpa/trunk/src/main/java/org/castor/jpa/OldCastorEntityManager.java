...
public class OldCastorEntityManager implements EntityManager {

    private final Log LOG = LogFactory.getLog(OldCastorEntityManager.class);
    ...
    public OldCastorEntityManager(final Database database) {
    ...
    private void checkIsOpen() {
        if (!isOpen()) {
            throw new IllegalStateException(
                    "Method called on inactive EntityManager instance.");
        }
    }

    /**
     * Checks whether there is an active transaction, if the specified
     * persistence context type is of type TRANSACTION.
     * 
     * @param persistenceContextType
     *            Specified persistence context type.
     * @throws TransactionRequiredException
     *             If there is not active transaction.
     */
    private void checkActiveTransaction(
        ...
        if (persistenceContextType == PersistenceContextType.TRANSACTION
            ...
            throw new TransactionRequiredException(
                    "Active transaction required when using persistence context type TRANSACTION");
        }
    }
    ...
    public void persist(Object entity) {
        ...
        try {
            ...
            throw new IllegalArgumentException(entity.getClass().getName()
                    + " is not a valid entity", e);
        } catch (DuplicateIdentityException e) {
            throw new EntityExistsException("Entity of type "
                    + entity.getClass().getName() + " exists already", e);
        } catch (TransactionNotInProgressException e) {
            TransactionRequiredException tre =
    ...
    public void remove(Object entity) {
        ...
        try {
            ...
            throw new javax.persistence.EntityNotFoundException(
                    "Object of type " + entity.getClass().getName()
                            + " not found");
        } catch (LockNotGrantedException e) {
            // TODO !!!!!!!!!!!! Investigate what should be done !!!!!!!!!!!!!!
            throw new javax.persistence.PersistenceException(
                    "Lock not granted by Castor", e);
        } catch (TransactionNotInProgressException e) {
            TransactionRequiredException tre =
                    new TransactionRequiredException(
    ...
    public <T> T find(Class<T> entityClass, Object primaryKey) {
        ...
        // TODO throw IllegalArgumentException if the first argument does not
        // denote an entity type

        // TODO throw IllegalArgumentException if the second argument is not a
        ...
        try {
            ...
            // entityClass.getName() + " with id " + primaryKey + " not found",
            // e);
        } catch (TransactionNotInProgressException e) {
            TransactionRequiredException tre =
                    new TransactionRequiredException(
            ...
            throw new javax.persistence.PersistenceException("General problem",
                    e);
        }
    ...
    public <T> T getReference(Class<T> entityClass, Object primaryKey) {
        ...
        // denote an entity type
        //        
        // // TODO throw IllegalArgumentException if the second argument is not
        // a valid type for that entity’s primary key
        //
        // try {
        ...
        // catch (ObjectNotFoundException e) {
        // throw new EntityNotFoundException("Entity of type " +
        // entityClass.getName() + " with id " + primaryKey + " not found", e);
        // } catch (TransactionNotInProgressException e) {
        // throw new TransactionRequiredException("Active transaction required",
        // e);
        // } catch (LockNotGrantedException e) {
        // // TODO !!!!!!!!!!!! Investigate what should be done !!!!!!!!!!!!!!
        // throw new
        // javax.persistence.PersistenceException("Lock not granted by Castor",
        // e);
        // } catch (PersistenceException e) {
        // throw new javax.persistence.PersistenceException("General problem",
        // e);
