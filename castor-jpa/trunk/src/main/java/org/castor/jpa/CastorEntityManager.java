...
public class CastorEntityManager implements EntityManager {
	...
	public CastorEntityManager(final Database database) {
		setPersistenceContextType(PersistenceContextType.TRANSACTION);
	...
	private void checkNoOrDetachedEntity() {
		// TODO throw IllegalArgumentException if not an entity or entity is
		// detached
	}
	...
	public void persist(Object entity) {
		...
		try {
			...
			TransactionRequiredException tre = new TransactionRequiredException(
