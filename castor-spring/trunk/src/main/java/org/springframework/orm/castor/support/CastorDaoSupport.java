...
package org.springframework.orm.castor.support;
 ...
 * @see org.springframework.orm.castor.CastorInterceptor
 */
public abstract class CastorDaoSupport extends DaoSupport {
     ...
     * @see org.springframework.orm.castor.JDOManagerUtils#getDatabase
     */
     ...
     * @see #setCastorTemplate
     * @see org.springframework.orm.castor.dialect.CastorDialect#translateException(PersistenceException)
     */
     ...
     * @see org.springframework.orm.castor.JDOManagerUtils#releaseDatabase
     */
