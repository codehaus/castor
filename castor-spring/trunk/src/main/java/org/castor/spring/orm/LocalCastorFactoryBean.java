 ...
 * @throws MappingException If Castor cannot resolve the mapping file successfully. 
 ...
 * @param configuration JDOManager configuration file
 * @param databaseName Name of the database instance.
