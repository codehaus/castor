...
public class ArrayKeysHashMap extends AbstractMap implements Map, Cloneable,
     ...
     */
    public ArrayKeysHashMap(int initialCapacity, float loadFactor) {
     ...
     *              than zero.
     */
    public ArrayKeysHashMap(int initialCapacity) {
	...
	System.out.println("containsKey is called: "+key);
	Entry tab[] = table;
        if (key != null) {
	    int hash = 0;
    ...
    public Object clone() {
	try { 
	    ArrayKeysHashMap t = (ArrayKeysHashMap)super.clone();
	...
	if (keySet == null) {
		...
		public boolean remove(Object o) {
                    int oldSize = count;
                    ArrayKeysHashMap.this.remove(o);
		    return count != oldSize;
		}
		public void clear() {
		    ArrayKeysHashMap.this.clear();
		}
	    };
	}
	return keySet;
	...
	Entry[] table = ArrayKeysHashMap.this.table;
	...
	public void remove() {
	    ...
	    Entry[] tab = ArrayKeysHashMap.this.table;
